...
function preload(){
  ...
  green_balloon0Image = loadImage("green_balloon0.png");
  pink_balloon0Image = loadImage("pink_balloon0.png");
  blue_balloon0Image = loadImage("blue_balloon0.png");

  red_balloon0Image = loadImage("red_balloon0.png");
  red_balloon0Image = loadImage("red_balloon0.png");
  red_balloon0Image = loadImage("red_balloon0.png");
  red_balloon0mage = loadImage("red_balloon0.png");
...
red.addImage(red_balloon0Image);
red.velocityX = 3;
red.lifetime = 150;
red.scale = 0.1;
 }
...
function blueBalloon() {
  ...
  blue.addImage(blue_balloon0Image);
  blue.velocityX = 3;
  blue.lifetime = 150;
  blue.scale = 0.1;
}
...
function greenBalloon() {
  ...
  green.addImage(green_balloon0Image);
  green.velocityX = 3;
  green.lifetime = 150;
  green.scale = 0.1;
}
...
function pinkBalloon() {
  ...
  pink.addImage(pink_balloon0Image);
  pink.velocityX = 3;
  pink.lifetime = 150;
  pink.scale = 1;
}
